...
router.add_api_route("/generate", generate_report, methods=["POST"])

# Generate ZIP report endpoint
router.add_api_route("/generate-zip", generate_zip_report, methods=["POST"])

# Preview report endpoint
router.add_api_route("/preview", preview_report, methods=["POST"])
