...
USAGE:
  from bulk.eventos import CasoEpidemiologicosManager

  manager = CasoEpidemiologicosManager(context, logger)
...
class CasoEpidemiologicosManager:
    ...
    def __init__(self, context, logger):
        ...
        from .processor import CasoEpidemiologicosProcessor
        from .sintomas import SintomasProcessor

        # Initialize all sub-processors
        self.eventos = CasoEpidemiologicosProcessor(context, logger)
    ...
    def upsert_agentes_eventos(
        ...
        deterministic rules defined per Enfermedad in REGLAS_POR_TIPO_ENO.
        """
