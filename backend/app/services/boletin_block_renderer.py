...
class BoletinBlockRenderer:
    ...
    def render_evento_section(
        ...
        titulo = config.get("titulo_template", "Análisis de Evento")
        titulo = titulo.replace("{{evento_nombre}}", data.get("tipo_eno_nombre", "Evento"))
    ...
    def render_eventos_agrupados_table(
        ...
        titulo_template = config.get("titulo", "Eventos Agrupados")
        titulo = render_template(titulo_template, ctx)
