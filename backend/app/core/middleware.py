...
from app.core.schemas.common import ErrorDetail, StandardResponse
...
class ExceptionHandlerMiddleware(BaseHTTPMiddleware):
    ...
    async def _handle_epidemiologia_exception(
        ...
        errors_list = [error_detail.model_dump()]
        response: StandardResponse[Any] = StandardResponse.error_response(
            message=exc.message,
            errors=errors_list
        )
        
        # Agregar metadata de debugging
    ...
    async def _handle_http_exception(
        ...
        errors_list = [error_detail.model_dump()]
        response: StandardResponse[Any] = StandardResponse.error_response(
            message=exc.detail or "Error en la petición",
            errors=errors_list
        )
