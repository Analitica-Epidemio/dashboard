...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_agente_etiologico_id_snvs'), 'agente_etiologico', ['id_snvs'], unique=False)
    op.create_index(op.f('ix_agente_etiologico_slug'), 'agente_etiologico', ['slug'], unique=True)
    op.create_table('agrupacion_agentes',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('slug', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    ...
    op.create_index('idx_agrupacion_activo', 'agrupacion_agentes', ['activo'], unique=False)
    op.create_index('idx_agrupacion_categoria', 'agrupacion_agentes', ['categoria'], unique=False)
    op.create_index('idx_agrupacion_slug', 'agrupacion_agentes', ['slug'], unique=False)
    op.create_index(op.f('ix_agrupacion_agentes_activo'), 'agrupacion_agentes', ['activo'], unique=False)
    op.create_index(op.f('ix_agrupacion_agentes_categoria'), 'agrupacion_agentes', ['categoria'], unique=False)
    op.create_index(op.f('ix_agrupacion_agentes_slug'), 'agrupacion_agentes', ['slug'], unique=True)
    ...
    op.create_table('boletin_secciones',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('slug', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    sa.Column('titulo', sqlmodel.sql.sqltypes.AutoString(length=300), nullable=False),
    ...
    op.create_index('idx_boletin_seccion_activo', 'boletin_secciones', ['activo'], unique=False)
    op.create_index('idx_boletin_seccion_orden', 'boletin_secciones', ['orden'], unique=False)
    op.create_index('idx_boletin_seccion_slug', 'boletin_secciones', ['slug'], unique=False)
    op.create_index(op.f('ix_boletin_secciones_activo'), 'boletin_secciones', ['activo'], unique=False)
    op.create_index(op.f('ix_boletin_secciones_orden'), 'boletin_secciones', ['orden'], unique=False)
    op.create_index(op.f('ix_boletin_secciones_slug'), 'boletin_secciones', ['slug'], unique=True)
    op.create_table('boletin_snippets',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_boletin_snippets_categoria'), 'boletin_snippets', ['categoria'], unique=False)
    op.create_index(op.f('ix_boletin_snippets_codigo'), 'boletin_snippets', ['codigo'], unique=True)
    ...
    sa.CheckConstraint('periodo_incubacion_max_dias IS NULL OR periodo_incubacion_min_dias IS NULL OR periodo_incubacion_max_dias >= periodo_incubacion_min_dias', name='ck_enfermedad_incubacion_valida'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_enfermedad_id_snvs'), 'enfermedad', ['id_snvs'], unique=True)
    op.create_index('ix_enfermedad_slug', 'enfermedad', ['slug'], unique=True)
    op.create_table('grupo_de_enfermedades',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_grupo_de_enfermedades_slug'), 'grupo_de_enfermedades', ['slug'], unique=True)
    op.create_index('ix_grupo_enfermedades_slug', 'grupo_de_enfermedades', ['slug'], unique=False)
    ...
    sa.Column('origen', sa.Enum('CLINICO', 'LABORATORIO', 'INTERNACION', name='origendatospasivos'), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_rango_etario_id_snvs'), 'rango_etario', ['id_snvs'], unique=False)
    ...
    op.create_table('tipo_evento_pasivo',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('slug', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    sa.Column('id_snvs', sa.Integer(), nullable=False),
    sa.Column('nombre', sqlmodel.sql.sqltypes.AutoString(length=300), nullable=False),
    sa.Column('grupo_nombre', sqlmodel.sql.sqltypes.AutoString(length=300), nullable=True),
    ...
    op.create_index(op.f('ix_tipo_evento_pasivo_id_snvs'), 'tipo_evento_pasivo', ['id_snvs'], unique=False)
    op.create_index('ix_tipo_evento_pasivo_origen', 'tipo_evento_pasivo', ['origen'], unique=False)
    op.create_index(op.f('ix_tipo_evento_pasivo_slug'), 'tipo_evento_pasivo', ['slug'], unique=True)
    op.create_index('ix_tipo_evento_pasivo_snvs', 'tipo_evento_pasivo', ['id_snvs'], unique=False)
    op.create_table('users',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('email', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('contrasena_hasheada', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('nombre', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    sa.Column('apellido', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    sa.Column('rol', sa.Enum('SUPERADMIN', 'EPIDEMIOLOGO', name='userrole'), nullable=False),
    sa.Column('estado', sa.Enum('ACTIVE', 'INACTIVE', 'SUSPENDED', name='userstatus'), nullable=False),
    sa.Column('es_email_verificado', sa.Boolean(), nullable=False),
    sa.Column('token_verificacion_email', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    sa.Column('token_reset_contrasena', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    sa.Column('expiracion_reset_contrasena', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.ForeignKeyConstraint(['id_enfermedad'], ['enfermedad.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_agente', 'id_enfermedad', 'campo_busqueda', name='uq_agente_enfermedad_campo')
    )
    ...
    op.create_index('idx_config_enfermedad', 'agente_extraccion_config', ['id_enfermedad'], unique=False)
    op.create_index(op.f('ix_agente_extraccion_config_activo'), 'agente_extraccion_config', ['activo'], unique=False)
    op.create_table('agrupacion_agente_link',
    sa.Column('agrupacion_id', sa.Integer(), nullable=False),
    sa.Column('agente_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['agente_id'], ['agente_etiologico.id'], ),
    sa.ForeignKeyConstraint(['agrupacion_id'], ['agrupacion_agentes.id'], ),
    sa.PrimaryKeyConstraint('agrupacion_id', 'agente_id')
    )
    op.create_index('idx_agrupacion_link_agente', 'agrupacion_agente_link', ['agente_id'], unique=False)
    op.create_index('idx_agrupacion_link_agrupacion', 'agrupacion_agente_link', ['agrupacion_id'], unique=False)
    ...
    op.create_table('boletin_bloques',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('seccion_id', sa.Integer(), nullable=False),
    sa.Column('slug', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    sa.Column('titulo_template', sqlmodel.sql.sqltypes.AutoString(length=500), nullable=False),
    sa.Column('tipo_bloque', sa.Enum('CORREDOR_ENDEMICO', 'CURVA_EPIDEMIOLOGICA', 'DISTRIBUCION_EDAD', 'TABLA_RESUMEN', 'COMPARACION_ANUAL', 'TOP_EVENTOS', 'TABLA_CASOS', name='tipobloque'), nullable=False),
    sa.Column('tipo_visualizacion', sa.Enum('AREA_CHART', 'STACKED_BAR', 'GROUPED_BAR', 'LINE_CHART', 'TABLE', name='tipovisualizacion'), nullable=False),
    sa.Column('metrica_codigo', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    sa.Column('dimensiones', sa.JSON(), nullable=False),
    sa.Column('compute', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    sa.Column('criterios_fijos', sa.JSON(), nullable=False),
    sa.Column('series_source', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    sa.Column('series_config', sa.JSON(), nullable=True),
    sa.Column('config_visual', sa.JSON(), nullable=False),
    sa.Column('orden', sa.Integer(), nullable=False),
    sa.Column('activo', sa.Boolean(), nullable=False),
    sa.Column('descripcion', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['seccion_id'], ['boletin_secciones.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_boletin_bloque_activo', 'boletin_bloques', ['activo'], unique=False)
    op.create_index('idx_boletin_bloque_orden', 'boletin_bloques', ['orden'], unique=False)
    op.create_index('idx_boletin_bloque_seccion', 'boletin_bloques', ['seccion_id'], unique=False)
    op.create_index('idx_boletin_bloque_slug', 'boletin_bloques', ['slug'], unique=False)
    op.create_index(op.f('ix_boletin_bloques_activo'), 'boletin_bloques', ['activo'], unique=False)
    op.create_index(op.f('ix_boletin_bloques_orden'), 'boletin_bloques', ['orden'], unique=False)
    op.create_index(op.f('ix_boletin_bloques_seccion_id'), 'boletin_bloques', ['seccion_id'], unique=False)
    op.create_index(op.f('ix_boletin_bloques_slug'), 'boletin_bloques', ['slug'], unique=True)
    ...
    op.create_table('enfermedad_grupo',
    sa.Column('id_enfermedad', sa.Integer(), nullable=False),
    sa.Column('id_grupo', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_enfermedad'], ['enfermedad.id'], ),
    sa.ForeignKeyConstraint(['id_grupo'], ['grupo_de_enfermedades.id'], ),
    ...
    op.create_table('estrategia_clasificacion',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_enfermedad', sa.Integer(), nullable=False),
    ...
    op.create_index('idx_estrategia_clasificacion_active', 'estrategia_clasificacion', ['is_active'], unique=False)
    op.create_index('idx_estrategia_clasificacion_tipo_enfermedad', 'estrategia_clasificacion', ['id_enfermedad'], unique=False)
    op.create_index('idx_estrategia_clasificacion_validity', 'estrategia_clasificacion', ['id_enfermedad', 'valid_from', 'valid_until'], unique=False)
    op.create_index(op.f('ix_estrategia_clasificacion_is_active'), 'estrategia_clasificacion', ['is_active'], unique=False)
    op.create_index(op.f('ix_estrategia_clasificacion_name'), 'estrategia_clasificacion', ['name'], unique=False)
    ...
    sa.Column('email_intentado', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('exito', sa.Boolean(), nullable=False),
    sa.Column('motivo_fallo', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    sa.Column('direccion_ip', sqlmodel.sql.sqltypes.AutoString(length=45), nullable=True),
    sa.Column('agente_usuario', sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True),
    sa.Column('intentado_en', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_user_logins_email_intentado'), 'user_logins', ['email_intentado'], unique=False)
    op.create_index(op.f('ix_user_logins_user_id'), 'user_logins', ['user_id'], unique=False)
    op.create_table('user_sessions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('token_sesion', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('direccion_ip', sqlmodel.sql.sqltypes.AutoString(length=45), nullable=True),
    sa.Column('agente_usuario', sqlmodel.sql.sqltypes.AutoString(length=500), nullable=True),
    sa.Column('huella_dispositivo', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index(op.f('ix_user_sessions_token_sesion'), 'user_sessions', ['token_sesion'], unique=True)
    ...
    op.create_table('caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('clasificacion_estrategia', sa.Enum('CONFIRMADOS', 'SOSPECHOSOS', 'PROBABLES', 'EN_ESTUDIO', 'NEGATIVOS', 'DESCARTADOS', 'NOTIFICADOS', 'CON_RESULTADO_MORTAL', 'SIN_RESULTADO_MORTAL', 'REQUIERE_REVISION', 'TODOS', name='tipoclasificacion'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['id_estrategia_aplicada'], ['estrategia_clasificacion.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_caso_domicilio_fecha', 'caso_epidemiologico', ['id_domicilio', 'fecha_minima_caso'], unique=False)
    op.create_index('idx_caso_enfermedad_fecha', 'caso_epidemiologico', ['id_enfermedad', 'fecha_minima_caso'], unique=False)
    op.create_index('idx_caso_fecha_minima', 'caso_epidemiologico', ['fecha_minima_caso'], unique=False)
    op.create_index(op.f('ix_caso_epidemiologico_fecha_minima_caso_anio_epi'), 'caso_epidemiologico', ['fecha_minima_caso_anio_epi'], unique=False)
    op.create_index(op.f('ix_caso_epidemiologico_fecha_minima_caso_semana_epi'), 'caso_epidemiologico', ['fecha_minima_caso_semana_epi'], unique=False)
    op.create_index(op.f('ix_caso_epidemiologico_id_domicilio'), 'caso_epidemiologico', ['id_domicilio'], unique=False)
    op.create_index(op.f('ix_caso_epidemiologico_id_snvs'), 'caso_epidemiologico', ['id_snvs'], unique=True)
    ...
    sa.ForeignKeyConstraint(['strategy_id'], ['estrategia_clasificacion.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('notificacion_semanal',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_snvs', sa.BigInteger(), nullable=False),
    ...
    sa.Column('origen', sa.Enum('CLINICO', 'LABORATORIO', 'INTERNACION', name='origendatospasivos'), nullable=False),
    sa.Column('estado', sa.Enum('CARGADA_CON_CASOS', 'CARGADA_SIN_CASOS', 'PENDIENTE', 'ERROR', name='estadonotificacion'), nullable=False),
    sa.Column('fecha_registro_snvs', sa.DateTime(), nullable=True),
    sa.Column('usuario_snvs', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    sa.Column('establecimiento_nombre_original', sqlmodel.sql.sqltypes.AutoString(length=300), nullable=True),
    sa.Column('localidad_codigo_snvs', sa.Integer(), nullable=True),
    sa.Column('localidad_nombre', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    sa.Column('departamento_codigo_snvs', sa.Integer(), nullable=True),
    sa.Column('departamento_nombre', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    sa.Column('establecimiento_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['establecimiento_id'], ['establecimiento.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_notif_estab_periodo', 'notificacion_semanal', ['establecimiento_id', 'anio', 'semana'], unique=False)
    op.create_index('ix_notif_periodo', 'notificacion_semanal', ['anio', 'semana'], unique=False)
    op.create_index('ix_notif_snvs', 'notificacion_semanal', ['id_snvs'], unique=False)
    op.create_index(op.f('ix_notificacion_semanal_establecimiento_id'), 'notificacion_semanal', ['establecimiento_id'], unique=False)
    op.create_index(op.f('ix_notificacion_semanal_id_snvs'), 'notificacion_semanal', ['id_snvs'], unique=True)
    ...
    op.create_table('ambitos_concurrencia_caso',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['id_caso'], ['caso_epidemiologico.id'], ),
    ...
    op.create_table('antecedentes_caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['id_caso'], ['caso_epidemiologico.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_caso', 'id_antecedente_epidemiologico', name='uq_caso_antecedente')
    )
    op.create_table('caso_agente',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_caso', sa.Integer(), nullable=False),
    ...
    op.create_index('idx_caso_agente_agente', 'caso_agente', ['id_agente'], unique=False)
    op.create_index('idx_caso_agente_caso', 'caso_agente', ['id_caso'], unique=False)
    op.create_index('idx_caso_agente_fecha', 'caso_agente', ['fecha_deteccion'], unique=False)
    op.create_index('idx_caso_agente_resultado', 'caso_agente', ['resultado'], unique=False)
    op.create_index(op.f('ix_caso_agente_fecha_deteccion'), 'caso_agente', ['fecha_deteccion'], unique=False)
    op.create_index(op.f('ix_caso_agente_resultado'), 'caso_agente', ['resultado'], unique=False)
    op.create_table('caso_grupo_enfermedad',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_caso', sa.Integer(), nullable=False),
    ...
    op.create_table('conteo_camas_ira',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_snvs', sa.BigInteger(), nullable=False),
    sa.Column('cantidad', sa.SmallInteger(), nullable=False),
    sa.Column('sexo', sa.Enum('MASCULINO', 'FEMENINO', 'SIN_ESPECIFICAR', name='sexo'), nullable=False),
    sa.Column('fecha_registro_snvs', sa.DateTime(), nullable=True),
    sa.Column('usuario_snvs', sqlmodel.sql.sqltypes.AutoString(length=200), nullable=True),
    ...
    sa.ForeignKeyConstraint(['notificacion_id'], ['notificacion_semanal.id'], ),
    sa.ForeignKeyConstraint(['rango_etario_id'], ['rango_etario.id'], ),
    sa.ForeignKeyConstraint(['tipo_evento_id'], ['tipo_evento_pasivo.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_conteo_camas_ira_id_snvs'), 'conteo_camas_ira', ['id_snvs'], unique=False)
    op.create_index(op.f('ix_conteo_camas_ira_notificacion_id'), 'conteo_camas_ira', ['notificacion_id'], unique=False)
    op.create_index(op.f('ix_conteo_camas_ira_rango_etario_id'), 'conteo_camas_ira', ['rango_etario_id'], unique=False)
    op.create_index(op.f('ix_conteo_camas_ira_tipo_evento_id'), 'conteo_camas_ira', ['tipo_evento_id'], unique=False)
    op.create_index('ix_conteo_int_analytics', 'conteo_camas_ira', ['notificacion_id', 'tipo_evento_id'], unique=False)
    op.create_index('ix_conteo_int_evento', 'conteo_camas_ira', ['tipo_evento_id'], unique=False)
    op.create_index('ix_conteo_int_notif', 'conteo_camas_ira', ['notificacion_id'], unique=False)
    op.create_table('conteo_casos_clinicos',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_snvs', sa.BigInteger(), nullable=False),
    ...
    op.create_index(op.f('ix_conteo_casos_clinicos_id_snvs'), 'conteo_casos_clinicos', ['id_snvs'], unique=False)
    op.create_index(op.f('ix_conteo_casos_clinicos_notificacion_id'), 'conteo_casos_clinicos', ['notificacion_id'], unique=False)
    op.create_index(op.f('ix_conteo_casos_clinicos_rango_etario_id'), 'conteo_casos_clinicos', ['rango_etario_id'], unique=False)
    op.create_index(op.f('ix_conteo_casos_clinicos_tipo_evento_id'), 'conteo_casos_clinicos', ['tipo_evento_id'], unique=False)
    op.create_index('ix_conteo_cli_analytics', 'conteo_casos_clinicos', ['notificacion_id', 'tipo_evento_id'], unique=False)
    op.create_index('ix_conteo_cli_evento', 'conteo_casos_clinicos', ['tipo_evento_id'], unique=False)
    op.create_index('ix_conteo_cli_notif', 'conteo_casos_clinicos', ['notificacion_id'], unique=False)
    op.create_table('conteo_estudios_lab',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_snvs', sa.BigInteger(), nullable=False),
    ...
    op.create_index(op.f('ix_conteo_estudios_lab_id_agente'), 'conteo_estudios_lab', ['id_agente'], unique=False)
    op.create_index(op.f('ix_conteo_estudios_lab_id_snvs'), 'conteo_estudios_lab', ['id_snvs'], unique=False)
    op.create_index(op.f('ix_conteo_estudios_lab_notificacion_id'), 'conteo_estudios_lab', ['notificacion_id'], unique=False)
    op.create_index(op.f('ix_conteo_estudios_lab_rango_etario_id'), 'conteo_estudios_lab', ['rango_etario_id'], unique=False)
    op.create_index('ix_conteo_lab_agente', 'conteo_estudios_lab', ['id_agente'], unique=False)
    op.create_index('ix_conteo_lab_analytics', 'conteo_estudios_lab', ['notificacion_id', 'id_agente'], unique=False)
    op.create_index('ix_conteo_lab_notif', 'conteo_estudios_lab', ['notificacion_id'], unique=False)
    op.create_table('detalle_caso_sintomas',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('diagnostico_caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index('idx_event_classification_audit_evento', 'event_classification_audit', ['id_caso'], unique=False)
    ...
    op.create_index(op.f('ix_event_classification_audit_id_caso'), 'event_classification_audit', ['id_caso'], unique=False)
    ...
    op.create_table('internacion_caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('investigacion_caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('muestra_caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_muestra_caso_epidemiologico_id_snvs_muestra'), 'muestra_caso_epidemiologico', ['id_snvs_muestra'], unique=False)
    op.create_table('tratamiento_caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_caso', 'descripcion_tratamiento', 'fecha_inicio_tratamiento', name='uq_tratamiento_caso')
    )
    ...
    op.create_table('estudio_caso_epidemiologico',
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('id_muestra', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['id_muestra'], ['muestra_caso_epidemiologico.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_muestra_caso_epidemiologico_id_snvs_muestra'), table_name='muestra_caso_epidemiologico')
    ...
    op.drop_index(op.f('ix_event_classification_audit_id_caso'), table_name='event_classification_audit')
    ...
    op.drop_index(op.f('ix_conteo_estudios_lab_rango_etario_id'), table_name='conteo_estudios_lab')
    op.drop_index(op.f('ix_conteo_estudios_lab_notificacion_id'), table_name='conteo_estudios_lab')
    op.drop_index(op.f('ix_conteo_estudios_lab_id_snvs'), table_name='conteo_estudios_lab')
    op.drop_index(op.f('ix_conteo_estudios_lab_id_agente'), table_name='conteo_estudios_lab')
    ...
    op.drop_index(op.f('ix_conteo_casos_clinicos_tipo_evento_id'), table_name='conteo_casos_clinicos')
    op.drop_index(op.f('ix_conteo_casos_clinicos_rango_etario_id'), table_name='conteo_casos_clinicos')
    op.drop_index(op.f('ix_conteo_casos_clinicos_notificacion_id'), table_name='conteo_casos_clinicos')
    op.drop_index(op.f('ix_conteo_casos_clinicos_id_snvs'), table_name='conteo_casos_clinicos')
    ...
    op.drop_index(op.f('ix_conteo_camas_ira_tipo_evento_id'), table_name='conteo_camas_ira')
    op.drop_index(op.f('ix_conteo_camas_ira_rango_etario_id'), table_name='conteo_camas_ira')
    op.drop_index(op.f('ix_conteo_camas_ira_notificacion_id'), table_name='conteo_camas_ira')
    ...
    op.drop_index(op.f('ix_notificacion_semanal_id_snvs'), table_name='notificacion_semanal')
    op.drop_index(op.f('ix_notificacion_semanal_establecimiento_id'), table_name='notificacion_semanal')
    ...
    op.drop_index(op.f('ix_caso_epidemiologico_id_snvs'), table_name='caso_epidemiologico')
    op.drop_index(op.f('ix_caso_epidemiologico_id_domicilio'), table_name='caso_epidemiologico')
    op.drop_index(op.f('ix_caso_epidemiologico_fecha_minima_caso_semana_epi'), table_name='caso_epidemiologico')
    op.drop_index(op.f('ix_caso_epidemiologico_fecha_minima_caso_anio_epi'), table_name='caso_epidemiologico')
    ...
    op.drop_index(op.f('ix_estrategia_clasificacion_name'), table_name='estrategia_clasificacion')
    op.drop_index(op.f('ix_estrategia_clasificacion_is_active'), table_name='estrategia_clasificacion')
    op.drop_index('idx_estrategia_clasificacion_validity', table_name='estrategia_clasificacion')
    op.drop_index('idx_estrategia_clasificacion_tipo_enfermedad', table_name='estrategia_clasificacion')
    op.drop_index('idx_estrategia_clasificacion_active', table_name='estrategia_clasificacion')
    ...
    op.drop_index(op.f('ix_tipo_evento_pasivo_id_snvs'), table_name='tipo_evento_pasivo')
    ...
    op.drop_index(op.f('ix_grupo_de_enfermedades_slug'), table_name='grupo_de_enfermedades')
    ...
    op.drop_index(op.f('ix_agrupacion_agentes_categoria'), table_name='agrupacion_agentes')
