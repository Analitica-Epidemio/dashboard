...
Revision ID: fbe0f27a3ce9
Revises: 
Create Date: 2025-12-05 21:30:32.535634
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', 'id_enfermedad', 'id_grupo'),
    ...
    sa.ForeignKeyConstraint(['codigo_ciudadano'], ['ciudadano.codigo_ciudadano'], ),
    sa.ForeignKeyConstraint(['id_evento'], ['caso_epidemiologico.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
