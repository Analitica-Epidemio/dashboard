      ...
      <div className="min-h-screen bg-white p-8" id="report-content">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-gray-600">
            {dateRange.from && dateRange.to && (
              <>
                Período: {formatDate(dateRange.from)} -{" "}
        ...
        <div className="space-y-8">
          {reportData.map((combination, index: number) => (
            <div key={combination.id} className="combination-section">
              {/* Section Header */}
              <Card className="mb-6 section-header">
                <CardHeader>
              ...
              {combination.indicadores && (
                <div className="mb-6 indicators-grid grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              {combination.charts && combination.charts.length > 0 && (
                <div className="charts-grid grid grid-cols-1 md:grid-cols-2 gap-4">
                  {combination.charts.map(
                    (chart: {
                      codigo: string;
                      nombre: string;
                      descripcion?: string;
                      ...
                      <div key={chart.codigo} className="chart-container">
                        <DynamicChart
                          codigo={chart.codigo}
                          nombre={chart.nombre}
