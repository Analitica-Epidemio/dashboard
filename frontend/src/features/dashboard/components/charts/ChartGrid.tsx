    ...
    () => [
      {
        ...
        props: {
          filters,
          chartConfig: {
            height: expandedChart === "epidemiological-curve" ? 800 : 400,
          },
      ...
      },
      {
        ...
        props: {
          filters,
          chartConfig: {
            height: expandedChart === "endemic-corridor" ? 800 : 400,
          },
      ...
      },
      {
        ...
        props: {
          filters,
          chartConfig: {
            height: expandedChart === "ugd-distribution" ? 700 : 350,
          },
          chartType: "pie",
          showMortalityData: true,
        },
      },
      {
        ...
        props: {
          filters,
          chartConfig: {
            height: expandedChart === "historical-totals" ? 800 : 400,
          },
          chartType: "line",
      ...
      },
      {
        ...
        props: {
          filters,
          chartConfig: {
            height: expandedChart === "suicide-attempt" ? 800 : 500,
          },
      ...
      },
      {
        ...
        props: {
          filters,
          chartConfig: {
            height: expandedChart === "animal-rabies" ? 800 : 500,
          },
          defaultView: "temporal",
    ...
    <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <Badge
                        variant="outline"
                        className={`text-xs ${
                          chart.category === "primary"
                            ? "bg-blue-50 text-blue-700"
                            : chart.category === "secondary"
      ...
      <div className="bg-gray-50 rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-between text-sm text-gray-600">
          <div>Datos actualizados: {new Date().toLocaleString("es-ES")}</div>
