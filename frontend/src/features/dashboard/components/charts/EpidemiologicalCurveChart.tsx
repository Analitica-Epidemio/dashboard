...
import type { TooltipProps, EpidemiologicalPayload } from "../../types/recharts";
...
const CustomTooltip: React.FC<TooltipProps<EpidemiologicalPayload>> = ({ active, payload, label }) => {
            ...
            >
              <div className="flex items-center gap-2 min-w-0">
                ...
                <span className="text-sm text-gray-700 truncate">
                  {typeof entry.name === 'string' ? entry.name.replace("_", " ") : entry.name}
                </span>
              </div>
